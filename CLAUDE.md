...
A highly discoverable marketplace of 27 production-ready developer tools for agentic AI ecosystems, targeting Claude Code and Claude Cowork plugins. Plugins provide commands, agents, skills, hooks, and MCP server integrations that extend AI assistant workflows.
...
- Ensure `plugin.json` description accurately positions the tool to improve agentic discoverability in plugin marketplaces
