...
export function CommandCopy({ command }: CommandCopyProps) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="group relative bg-linear-to-r from-white/5 to-white/10 border border-white/10 px-6 py-4 rounded-xl font-mono text-cyan-400 flex items-center gap-3 shadow-xl shadow-cyan-500/5 hover:shadow-cyan-500/10 transition-all hover:bg-white/10 text-left w-full max-w-3xl cursor-pointer"
